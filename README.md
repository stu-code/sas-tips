...
05/28/24 | [unique_ids_in_cas.sas](https://github.com/stu-code/sas-tips/blob/main/unique_ids_in_cas.sas) | Create a unique ID three different ways in CAS | CAS, Data Engineering, Viya
