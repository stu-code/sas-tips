...
10/08/24 | [genmax.sas](https://github.com/stu-code/sas-tips/blob/main/genmax.sas) | Automatically create backups of your SAS datasets with the gennum dataset option | DATA Step, Data Engineering
