...
10/28/25 | [recursive_macros.sas](./recursive_macros.sas) | SAS macros support recursion. You may never need to do this in data science, but it's fun to know that it's there! | Computer Science, Data Engineering, Data Science, Programming
11/18/25 | [network_analysis_grouping.sas](./network_analysis_grouping.sas) | Solve a complex recursive grouping problem in 7 lines of code with PROC OPTNETWORK and PROC OPTNET | Computer Science, Data Engineering, Data Science, Network Analysis
