...
06/04/24 | [sequential_macro_variables.sas](https://github.com/stu-code/sas-tips/blob/main/sequential_macro_variables.sas) | Two ways to dynamically generate sequentially-ordered macro variables | Data Engineering, DATA Step, Macro, SQL
