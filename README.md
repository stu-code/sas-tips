...
03/19/24 | [sastrace.sas](https://github.com/stu-code/sas-tips/blob/main/sastrace.sas) | See what your database is doing when running SAS code against it in only one line of code | Efficiency, Data, Database  Engineering
...
05/14/24 | [speedy_stats.sas](https://github.com/stu-code/sas-tips/blob/main/speedy_stats.sas) | Calculate over a dozen statistics on a billion rows of data in seconds | CAS, Data Science, Data Engineering, Efficiency, Fast, PROCs, Statistics, Viya
